...
#data
data_150 <- read.csv("data_150_4.csv", sep="", stringsAsFactors=TRUE)
data_300 <- read.csv("data_300_3.csv", sep="", stringsAsFactors=TRUE)
data_450 <- read.csv("data_450_3.csv", sep="", stringsAsFactors=TRUE)
data_600 <- read.csv("data_600_3.csv", sep="", stringsAsFactors=TRUE)

######################################
#Bayesian interim analysis
######################################
# The model specification
file.show("pred_model_comp.txt")
...
for (l in 1:nrow(data)){
  data_list[[l]] <- list(
    ...
    p0= 0.1, #p_0 (prior probability of being in the slab)
  ...
  # Running the model
  model <- jags.model(file = "pred_model_comp.txt", data_list[[l]], n.chains = 3, n.adapt= 1000)
